...
textureLoader.load('assets/clock.jpg' , (texture:THREE.Texture)=> {
    const clockFaceGeometry = new THREE.CircleGeometry(4, 69);
    const clockFaceMaterial = new THREE.MeshBasicMaterial({map: texture,transparent: true,side: THREE.DoubleSide});
...
const pendulumSpeed = 4; // Speed of swinging
